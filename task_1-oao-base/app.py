...
class ClassificationModel:
    def __init__(self):
        self.models = {
            "passage": AutoModelForSequenceClassification.from_pretrained("/models/roberta-base-2_passage-2022-12-21-T17-34-28", num_labels=2,local_files_only=True),
            "phrase": AutoModelForSequenceClassification.from_pretrained("/models/roberta-base-1_phrase-2022-12-21-T17-20-38", num_labels=2,local_files_only=True),
            "multi": AutoModelForSequenceClassification.from_pretrained("/models/roberta-base-3_multi-2022-12-21-T19-36-44", num_labels=2,local_files_only=True)
        }
        self.tokenizer = AutoTokenizer.from_pretrained("/models/roberta-base-2_passage-2022-12-21-T17-34-28",local_files_only=True)
